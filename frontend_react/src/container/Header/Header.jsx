  ...
  return (
    <div id='home' className='app__header app__flex'>
        ...
        <div className='app__header-badge'>
          <div className='badge-cmp app__flex'>
            ...
            <div style={{ marginLeft: 20 }}>
              ...
              <h1 className='head-text'>Hung</h1>
            </div>
          </div>

          <div className='tag-cmp app__flex'>
            <p className='p-text'>Software Engineer</p>
            <p className='p-text'>B.S. Computer Science @ WPI</p>
          </div>
      ...
      <motion.div whileInView={{ opacity: [0, 1] }} transition={{ duration: 0.5, delayChildren: 0.5 }} className='app__header-img'>
        ...
        <motion.img whileInView={{ scale: [0, 1] }} transition={{ duration: 1.0, ease: 'easeInOut' }} src={ images.circle } alt='profile_circle' className='overlay_circle' />
      </motion.div>
